...
public class OldFilm3 extends JPanel {
	private Image image_back = new ImageIcon(OldFilm3.class.getResource("image/back_icon.png")).getImage().getScaledInstance(32, 26, Image.SCALE_SMOOTH);
	private Image image_poster = new ImageIcon(OldFilm3.class.getResource("posterNowShowing/poster_WW.jpg")).getImage().getScaledInstance(268, 380, Image.SCALE_SMOOTH);
	private Image image_buy = new ImageIcon(OldFilm3.class.getResource("image/buyticket_icon.png")).getImage().getScaledInstance(120, 70, Image.SCALE_SMOOTH);
	private Image image_trailer = new ImageIcon(OldFilm3.class.getResource("image/trailer_icon.png")).getImage().getScaledInstance(148, 64, Image.SCALE_SMOOTH);
	
	private final JLabel labelTitle = new JLabel("WONDER WOMAN1984: NỮ THẦN CHIẾN BINH");
	...
	private void initGUI() {
		...
		add(labelTitle);
		labelTitle.setBounds(54, 8, 693, 35);
		...
		labelImage3.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
			        Desktop.getDesktop().browse(new URI("https://www.youtube.com/watch?v=XW2E2Fnh52w"));
			    }
		...
		textFilm.setText("- Đạo diễn: Patty Jenkins" 
				+ "\n- Diễn viên: Gal Gadot, Chris Pine, Kristen Wiig, Pedro Pascal, Connie Nielsen"
				+ "\n- Thể loại: Hành Động, Thần thoại"
				+ "\n- Khởi chiếu: 18/12/2020"
				+ "\n- Thời lượng: 151 phút"
				+ "\n- Ngôn ngữ:  Tiếng Anh - Phụ đề Tiếng Việt, Tiếng Hàn"
				+ "\n- Giới hạn độ tuổi: C13 - CẤM KHÁN GIẢ DƯỚI 13 TUỔI\n"
				
				+ "\nLấy bối cảnh năm 1984, 66 năm sau sự kiện diễn ra Thế "
				+ "\nChiến thứ I (1918) ở phần phim đầu tiên, Wonder Woman "
				+ "\ntái hợp với người yêu tưởng chừng như đã qua đời Steve "
				+ "\nTrevor, đồng thời đương đầu với hai kẻ thù mới là Max "
				+ "\nLord và The Cheetah.");
