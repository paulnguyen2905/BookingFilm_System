...
public class ConcessionWW18h15 extends JPanel {
	private Image image_Back = new ImageIcon(ConcessionWW18h15.class.getResource("image/back_icon.png")).getImage().getScaledInstance(32, 26, Image.SCALE_SMOOTH);
	private Image image_nextButton = new ImageIcon(ConcessionWW18h15.class.getResource("image/nextButton_icon.png")).getImage().getScaledInstance(80, 60, Image.SCALE_SMOOTH);
	private Image image_pairCombo = new ImageIcon(ConcessionWW18h15.class.getResource("image/cgvCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_myCombo = new ImageIcon(ConcessionWW18h15.class.getResource("image/myCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_oxCombo = new ImageIcon(ConcessionWW18h15.class.getResource("image/oxCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_increase = new ImageIcon(ConcessionWW18h15.class.getResource("image/increase_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
	private Image image_decrease = new ImageIcon(ConcessionWW18h15.class.getResource("image/decrease_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
	...
	public void initGUI() {
		...
		buttonBack.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				PanelBooking.cardLayout.show(PanelBooking.homeBookingPane, "8");
				WW18h15.str.clear();
				WW18h15.countSeatWW18h15 = 0;;
			}
		});	
		...
		buttonNext.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				FinalPaymentWW18h15.textSeat.setText((WW18h15.str).toString());
				FinalPaymentWW18h15.textPriceCombo.setText(Integer.toString(total1*249 + total2*79 + total3*99) + ".000 đ");
				FinalPaymentWW18h15.textPriceTicket.setText(Integer.toString(WW18h15.countSeatWW18h15*100) + ".000 đ");
				FinalPaymentWW18h15.textPriceTotal.setText(Integer.toString(WW18h15.countSeatWW18h15*100 + (total1*249 + total2*79 + total3*99)) + ".000 đ");

				PanelBooking.cardLayout.show(PanelBooking.homeBookingPane, "final8");
			}
		});
