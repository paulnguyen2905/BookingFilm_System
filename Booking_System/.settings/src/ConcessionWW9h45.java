...
public class ConcessionWW9h45 extends JPanel {
	private Image image_Back = new ImageIcon(ConcessionWW9h45.class.getResource("image/back_icon.png")).getImage().getScaledInstance(32, 26, Image.SCALE_SMOOTH);
	private Image image_nextButton = new ImageIcon(ConcessionWW9h45.class.getResource("image/nextButton_icon.png")).getImage().getScaledInstance(80, 60, Image.SCALE_SMOOTH);
	private Image image_pairCombo = new ImageIcon(ConcessionWW9h45.class.getResource("image/cgvCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_myCombo = new ImageIcon(ConcessionWW9h45.class.getResource("image/myCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_oxCombo = new ImageIcon(ConcessionWW9h45.class.getResource("image/oxCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_increase = new ImageIcon(ConcessionWW9h45.class.getResource("image/increase_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
	private Image image_decrease = new ImageIcon(ConcessionWW9h45.class.getResource("image/decrease_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
	...
	public void initGUI() {
		...
		buttonBack.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				PanelBooking.cardLayout.show(PanelBooking.homeBookingPane, "5");
				WW9h45.str.clear();
				WW9h45.countSeatWW9h45 = 0;;
			}
		});	
		...
		buttonNext.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				FinalPaymentWW9h45.textSeat.setText((WW9h45.str).toString());
				FinalPaymentWW9h45.textPriceCombo.setText(Integer.toString(total1*249 + total2*79 + total3*99) + ".000 đ");
				FinalPaymentWW9h45.textPriceTicket.setText(Integer.toString(WW9h45.countSeatWW9h45*100) + ".000 đ");
				FinalPaymentWW9h45.textPriceTotal.setText(Integer.toString(WW9h45.countSeatWW9h45*100 + (total1*249 + total2*79 + total3*99)) + ".000 đ");

				PanelBooking.cardLayout.show(PanelBooking.homeBookingPane, "final5");
			}
		});
