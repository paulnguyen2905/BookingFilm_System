...
public class OldFilm4 extends JPanel {
	private Image image_back = new ImageIcon(OldFilm4.class.getResource("image/back_icon.png")).getImage().getScaledInstance(32, 26, Image.SCALE_SMOOTH);
	private Image image_poster = new ImageIcon(OldFilm4.class.getResource("posterNowShowing/poster_NSK.jpg")).getImage().getScaledInstance(268, 380, Image.SCALE_SMOOTH);
	private Image image_buy = new ImageIcon(OldFilm4.class.getResource("image/buyticket_icon.png")).getImage().getScaledInstance(120, 70, Image.SCALE_SMOOTH);
	private Image image_trailer = new ImageIcon(OldFilm4.class.getResource("image/trailer_icon.png")).getImage().getScaledInstance(148, 64, Image.SCALE_SMOOTH);
	
	private final JLabel labelTitle = new JLabel("NGHỀ SIÊU KHÓ");
	...
	private void initGUI() {
		...
		labelImage3.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
			        Desktop.getDesktop().browse(new URI("https://www.youtube.com/watch?v=pTlqIQUkYQI&t=2s"));
			    }
		...
		textFilm.setText("- Đạo diễn: Lee Byeong-heon" 
				...
				+ "\nNhóm điều tra do đội trưởng Ko (Ryu Seung-yong) lãnh "
				+ "\nđạo đứng trước nguy cơ giải tán nhờ chuỗi “thành tích” "
				+ "\nthất bại đáng nể. Cơ hội cuối cùng để cứu vớt sự nghiệp "
				+ "\ncủa họ chính là phải triệt phá một băng đảng buôn bán "
				+ "\nma tuý tầm cỡ quốc tế. Để làm được điều đó, đội trưởng "
				+ "\nKo và các thành viên trong nhóm đã cải trang thành những "
				+ "\nnhân viên bán gà tại một quán ăn ngay đối diện hang ổ "
				+ "\ncủa kẻ địch. Trớ trêu thay, món gà rán của họ quá ngon "
				+ "\nvà nhà hàng bỗng chốc nổi như cồn, căn cứ địa có nguy "
				+ "\ncơ bại lộ khiến 5 cảnh sát chìm rơi vào những nguy hiểm "
				+ "\nkhó lường.");
