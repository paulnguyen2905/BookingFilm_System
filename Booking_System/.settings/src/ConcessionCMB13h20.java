...
public class ConcessionCMB13h20 extends JPanel {
	private Image image_Back = new ImageIcon(ConcessionCMB13h20.class.getResource("image/back_icon.png")).getImage().getScaledInstance(32, 26, Image.SCALE_SMOOTH);
	private Image image_nextButton = new ImageIcon(ConcessionCMB13h20.class.getResource("image/nextButton_icon.png")).getImage().getScaledInstance(80, 60, Image.SCALE_SMOOTH);
	private Image image_pairCombo = new ImageIcon(ConcessionCMB13h20.class.getResource("image/cgvCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_myCombo = new ImageIcon(ConcessionCMB13h20.class.getResource("image/myCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_oxCombo = new ImageIcon(ConcessionCMB13h20.class.getResource("image/oxCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_increase = new ImageIcon(ConcessionCMB13h20.class.getResource("image/increase_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
	private Image image_decrease = new ImageIcon(ConcessionCMB13h20.class.getResource("image/decrease_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
	...
	public void initGUI() {
		...
		buttonBack.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				PanelBooking.cardLayout.show(PanelBooking.homeBookingPane, "2");
				CMB13h20.str.clear();
				CMB13h20.countSeatCMB13h20 = 0;;
			}
		});	
		...
		buttonNext.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				FinalPaymentCMB13h20.textSeat.setText((CMB13h20.str).toString());
				FinalPaymentCMB13h20.textPriceCombo.setText(Integer.toString(total1*249 + total2*79 + total3*99) + ".000 đ");
				FinalPaymentCMB13h20.textPriceTicket.setText(Integer.toString(CMB13h20.countSeatCMB13h20*100) + ".000 đ");
				FinalPaymentCMB13h20.textPriceTotal.setText(Integer.toString(CMB13h20.countSeatCMB13h20*100 + (total1*249 + total2*79 + total3*99)) + ".000 đ");
				
				PanelBooking.cardLayout.show(PanelBooking.homeBookingPane, "final2");
			}
		});
