...
public class ConcessionCMB20h35 extends JPanel {
	private Image image_Back = new ImageIcon(ConcessionCMB20h35.class.getResource("image/back_icon.png")).getImage().getScaledInstance(32, 26, Image.SCALE_SMOOTH);
	private Image image_nextButton = new ImageIcon(ConcessionCMB20h35.class.getResource("image/nextButton_icon.png")).getImage().getScaledInstance(80, 60, Image.SCALE_SMOOTH);
	private Image image_pairCombo = new ImageIcon(ConcessionCMB20h35.class.getResource("image/cgvCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_myCombo = new ImageIcon(ConcessionCMB20h35.class.getResource("image/myCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_oxCombo = new ImageIcon(ConcessionCMB20h35.class.getResource("image/oxCombo_icon.png")).getImage().getScaledInstance(160, 160, Image.SCALE_SMOOTH);
	private Image image_increase = new ImageIcon(ConcessionCMB20h35.class.getResource("image/increase_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
	private Image image_decrease = new ImageIcon(ConcessionCMB20h35.class.getResource("image/decrease_icon.png")).getImage().getScaledInstance(20, 20, Image.SCALE_SMOOTH);
	...
	public void initGUI() {
		...
		buttonBack.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				PanelBooking.cardLayout.show(PanelBooking.homeBookingPane, "4");
				CMB20h35.str.clear();
				CMB20h35.countSeatCMB20h35 = 0;;
			}
		});	
		...
		buttonNext.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				FinalPaymentCMB20h35.textSeat.setText((CMB20h35.str).toString());
				FinalPaymentCMB20h35.textPriceCombo.setText(Integer.toString(total1*249 + total2*79 + total3*99) + ".000 đ");
				FinalPaymentCMB20h35.textPriceTicket.setText(Integer.toString(CMB20h35.countSeatCMB20h35*100) + ".000 đ");
				FinalPaymentCMB20h35.textPriceTotal.setText(Integer.toString(CMB20h35.countSeatCMB20h35*100 + (total1*249 + total2*79 + total3*99)) + ".000 đ");
				
				PanelBooking.cardLayout.show(PanelBooking.homeBookingPane, "final4");
			}
		});
