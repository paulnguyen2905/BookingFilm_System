...
public class NewFilm1 extends JPanel {
	...
	private Image image_poster = new ImageIcon(NewFilm1.class.getResource("posterComingSoon/poster_VSDC.jpg")).getImage().getScaledInstance(268, 380, Image.SCALE_SMOOTH);
	...
	private void initGUI() {
		...
		labelImage3.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
			        Desktop.getDesktop().browse(new URI("https://www.youtube.com/watch?v=mrNqbx4vUvA"));
			    }
		...
		textFilm.setText("- Đạo diễn: Nguyễn Bá Cường" 
				+ "\n- Diễn viên: Nguyễn Trần Duy Nhất, Gi A Nguyễn, MLee "
				+ "\nKatLeen Phan Võ, Duy Khánh … "
				...
				+ "\nVõ Sinh Đại Chiến kể về hành trình của Trần Anh Khoa, "
				+ "\ncon trai và là hậu duệ môn Võ Ta của Đại sư phụ Trần Anh"
				+ "\nPhong, người quyết tâm xây dựng lại danh tiếng cho nền "
				+ "\nvõ học truyền thống sau thảm bại của cha mình dưới tay"
				+ "\nQuyền vương MMA Cao Hùng.");
