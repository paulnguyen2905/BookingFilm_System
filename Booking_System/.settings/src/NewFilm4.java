...
public class NewFilm4 extends JPanel {
	...
	private Image image_poster = new ImageIcon(NewFilm1.class.getResource("posterComingSoon/poster_GGLC.jpg")).getImage().getScaledInstance(268, 380, Image.SCALE_SMOOTH);
	...
	private final JLabel labelTitle = new JLabel("GÁI GIÀ LẮM CHIÊU V");
	...
	private void initGUI() {
		...
		add(labelTitle);
		labelTitle.setBounds(54, 8, 346, 35);
		...
		labelImage3.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				try {
			        Desktop.getDesktop().browse(new URI("https://www.youtube.com/watch?v=y7h7qFJE__Q"));
			    }
		...
		textFilm.setText("- Đạo diễn: Bảo Nhân – Namcito" 
				+ "\n- Diễn viên: NSND Lê Khanh – Kaity Nguyễn - NSND Hồng"
				+ "\nVân – NSND Hoàng Dũng – Khương Lê – Lê Khánh – Anh"
				+ "\nDũng…"
				+ "\n- Thể loại: Hài, Tâm lý"
				+ "\n- Khởi chiếu: 12/02/2021 "
				+ "\n- Thời lượng: "
				+ "\n- Ngôn ngữ: Tiếng Việt - Phụ đề Tiếng Anh"
				+ "\n- Giới hạn độ tuổi: C13 - CẤM KHÁN GIẢ DƯỚI 13 TUỔI\n"
				
				+ "\nCuộc chiến “Chị - Em máu mủ tình thâm” chỉ vì hai chữ"
				+ "\nTÌNH- TIỀN của ba chị em gái Lý gia tại Biệt thự Bạch Trà"
				+ "\nViên xứ Huế. Chính vì vòng xoáy “tình – tiền, được – mất”"
				+ "\nđã khiến họ từ chị em trở thành những kẻ đối đầu trong"
				+ "\nmối quan hệ tình thân. Câu chuyện bắt đầu vào đêm đấu"
				+ "\ngiá phiên Xuân tại Bạch Trà Viên, Phượng bào tam vĩ - cổ"
				+ "\nvật 30 triệu đô, bảo vật của Lý gia bị mất cắp. Khiến ba chị"
				+ "\nem bắt đầu nghi kỵ lẫn nhau đồng thời phơi bày nhiều bí"
				+ "\nmật động trời tưởng chừng đã được che giấu suốt cả một"
				+ "\nđời người.");
